...
public class adñadirP extends javax.swing.JFrame {

    /**
     * Creates new form adñadirP
     */
    public adñadirP() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel1.add(Adñadir, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 360, 90, -1));
    ...
    ArrayList<String> inputs = new ArrayList<>();
     ...
     if (inputs.contains("")) {
          ...
          Proveedor proveedor = new Proveedor(TxtEmpesa.getText(),txtFechaentrega.getText());
          proveedor.agregarProducto(txtProducto.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(adñadirP.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
